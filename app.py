...
# =======================
# 2️⃣ Load ANN Model & Feature Columns
# =======================
model = tf.keras.models.load_model("ann_model.keras")
feature_columns = joblib.load("feature_columns.pkl")  # columns used for model
...
# =======================
    ...
    # Categorical Feature: Package Type
